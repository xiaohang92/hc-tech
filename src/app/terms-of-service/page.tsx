        ...
        <div className="prose prose-lg max-w-none">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-700">
                    Projects begin upon receipt of the required booking fee and
                    project approval. All projects require a 50% deposit before
                    work begins, with the remaining balance due upon project
                    completion.
                  </p>
                </div>
                <div>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Late payments may result in project suspension and may incur
                    additional fees. We reserve the right to charge interest on
                    overdue amounts.
                  </p>
                </div>
              </div>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
                <li>Provide timely feedback and responses to our inquiries</li>
                <li>
                  Supply necessary content, images, and materials for your
                  project
                </li>
                <li>
                  Review and approve project milestones within agreed timeframes
                </li>
                <li>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-700">
                    ...
                    you provide. You grant us a license to use this content for
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Upon final payment, you receive full ownership of the final
                    website or application. We retain the right to showcase your
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-700">
                    ...
                    for any bugs or issues related to our development work.
                  </p>
                </div>
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">
